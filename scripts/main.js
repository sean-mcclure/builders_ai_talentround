    ...
    form: function(options) {
        ...
        document.getElementById("submit_button").addEventListener("click", async function() {
            ...
            try {
                ...
                // Create a new object in your class (e.g., "Resumes")
                const Resume = Parse.Object.extend("Resumes");
                const resumeObject = new Resume();

                // Attach file and other fields if needed
                resumeObject.set("resume", parseFile);
                // resumeObject.set("user", Parse.User.current()); // Optional: associate with user

                await resumeObject.save();
